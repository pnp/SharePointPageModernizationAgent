...
const FULL_CATALOG: CatalogEntry[] = [
  {
    ...
    propertiesSchema: {
      ...
      siteId: 'string — source site collection GUID',
      webId: 'string — source web GUID',
      listId: 'string — source image library GUID',
      uniqueId: 'string — source image file GUID',
      imgWidth: 'number — natural image width',
      imgHeight: 'number — natural image height',
      alignment: 'string — Left | Center | Right',
    },
    serverProcessedContent: {
      'imageSources.imageSource': 'string — URL of the image',
      'links.linkUrl': 'string — optional click-through URL',
      'customMetadata.imageSource': 'object — source file IDs and dimensions for a same-site image',
    },
    example: {
      ...
      data: {
        ...
        serverProcessedContent: {
          imageSources: { imageSource: '/sites/team/SiteAssets/logo.png' },
          links: {},
          customMetadata: {
            imageSource: {
              siteId: 'site-id',
  ...
  },
  {
    ...
    propertiesSchema: {
      ...
      title: 'string — visible Quick Links web part heading',
  ...
  },
  {
    ...
    supportedOn: ['v1.0', 'beta'],
    inGaWhitelist: true,
    builderTool: 'build_list_webpart',
    propertiesSchema: {
      isDocumentLibrary: 'boolean — true for a document library',
      ...
      webRelativeListUrl: 'string — list URL relative to the destination web',
      webpartHeightKey: 'number — list web part height preset',
      selectedFolderPath: 'string — folder path, empty for the list root',
      hideCommandBar: 'boolean — whether to hide List commands',
    },
    serverProcessedContent: {
      listTitle: 'string — destination list title in searchablePlainTexts',
    },
    example: {
      ...
      data: {
        ...
        properties: {
          ...
          selectedViewId: '',
          selectedListUrl: '',
          webRelativeListUrl: '/Lists/Items',
          webpartHeightKey: 4,
          selectedFolderPath: '',
          hideCommandBar: false,
        },
        serverProcessedContent: {
          searchablePlainTexts: { listTitle: 'Items' },
        },
      },
    },
  },
