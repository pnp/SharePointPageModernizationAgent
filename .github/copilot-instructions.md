...
- Use `advanced-page-refinement` for an explicit, comprehensive visual-fidelity pass on an existing modern page, including Text web-part styling and unresolved placeholders.
